...
public class VPArray extends VPBase
{
	...
	public static VPArray Byte(String name, byte[] data)
	{
		VPArray array = new VPArray();
		array.setName(name);
	...
	public static VPArray Short(String name, short[] data)
	{
		VPArray array = new VPArray();
		array.setName(name);
	...
	public static VPArray Char(String name, char[] data)
	{
		VPArray array = new VPArray();
		array.setName(name);
	...
	public static VPArray Integer(String name, int[] data)
	{
		VPArray array = new VPArray();
		array.setName(name);
		array.type = Type.INT;
	...
	public static VPArray Long(String name, long[] data)
	{
		VPArray array = new VPArray();
		array.setName(name);
	...
	public static VPArray Float(String name, float[] data)
	{
		VPArray array = new VPArray();
		array.setName(name);
	...
	public static VPArray Double(String name, double[] data)
	{
		VPArray array = new VPArray();
		array.setName(name);
	...
	public static VPArray Boolean(String name, boolean[] data)
	{
		VPArray array = new VPArray();
		array.setName(name);
	...
	public static VPArray Deserialize(byte[] data, int pointer)
	{
		byte containerType = data[pointer++];
		assert(containerType == CONTAINER_TYPE);
		
		VPArray result = new VPArray();
